...
- `skills/<name>/` — the entry `SKILL.md`, `agents/openai.yaml`, and linked
  references, shipped whole. Fragment and extension-prompt render points work
  in all regular Markdown files, including nested references.
